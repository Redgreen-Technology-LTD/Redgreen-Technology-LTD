...
const OnePlus32 = () => {
  const details = {
    id: 1,
    path: '/oneplus/y1g-32',
    pName: 'OnePlus TV Y1G 32 Inch Android 11 Updated Global Version',
    ...
    oneplus32: {
      ...
      oldPrice: '29,990 ৳',
      color: 'Black',
      name: 'OnePlus TV Y1G 32 Inch Android 11 Updated Global Version',
      model: 'Y1G',
        ...
        <div className="product-content">
          ...
          <div className="product-price">
            <p className="last-price">
              Old Price: <span>{details.oneplus32.oldPrice}</span>
            </p>
            <p className="new-price">
              New Price: <span>{details.oneplus32.newPrice}</span>
            </p>
          </div>
          ...
          <div className="product-detail">
            ...
            <ul>
              <li>
                Color: <span>{details.oneplus32.color}</span>
              </li>
              <li>
                Model: <span>{details.oneplus32.model}</span>
              </li>
              <li>
                Resolution: <span>{details.oneplus32.resolution}</span>
              </li>
              <li>
                Ram: <span>{details.oneplus32.ram}</span>
              </li>
              <li>
                Rom: <span>{details.oneplus32.rom}</span>
              </li>
              <li>
                Display: <span>{details.oneplus32.display}</span>
              </li>
            </ul>
          </div>
          ...
          <div className="purchase-info">
            <button type="button" className="btn">
              <a
                href="https://www.daraz.com.bd/products/oneplus-tv-y1g-32-inch-android-11-updated-global-version-i271000712-s1242689096.html?search=store&mp=3&spm=a2a0e.8553159.countdownProduct_19209879.0"
                target="_blank"
              >
